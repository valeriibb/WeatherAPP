...
function Card (props) {
  ...
  class WeekContainer extends React.Component {
    ...
    weatherURL = `https://api.openweathermap.org/data/2.5/forecast?q=${this.propscity}&lang=uk&units=${WEATHER_API_URL}`;
    ...
    formatCards = () => {
      return this.state.days.map((city,day, index) => <Card city={city} day={day} key={index}/>)
    }
