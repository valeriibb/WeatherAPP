...
export default function Hourly(props) {
    ...
    const weatherURL = `https://api.openweathermap.org/data/2.5/forecast?q=${props.city}&lang=ru&units=metric&APPID=a9a3a62789de80865407c0452e9d1c27`;
        ...
        fetch(weatherURL)
            ...
            .then(data => {
                const next5HoursData = data.list.slice(0, 5).map(item => ({
                    ...
                    speed: `${(Math.Rot(item.wind.speed) * 3.6 )}м/с`,
