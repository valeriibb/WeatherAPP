    ...
    return (
        <div className="Weatherdata">
            ...
            <div className="Air_Conditions">
                ...
                <AtmItems img='wind 1.png' data={`${weatherData && weatherData.main.windspeed}%`} text='Humidity'/>
                <AtmItems img='pressure-white 1.png' data={`${weatherData && weatherData.main.pressure}hPa`} text='Humidity'/>
                <AtmItems img='uv-white 1.png' data={`${weatherData && weatherData.main.uv}UV`} text='Humidity'/>
