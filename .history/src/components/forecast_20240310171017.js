...
const weatherURL = `https://api.openweathermap.org/data/2.5/forecast?q=${city}&lang=uk&units=${WEATHER_API_URL}`;
...
function Card (props) {
  ...
  class WeekContainer extends React.Component {
    ...
    weatherURL = `https://api.openweathermap.org/data/2.5/forecast?q=${city}&lang=uk&units=${WEATHER_API_URL}`;
    ...
    formatCards = () => {
      return this.state.days.map((city,day, index) => <Card city={this.props.city} day={day} key={index}/>)
    }
