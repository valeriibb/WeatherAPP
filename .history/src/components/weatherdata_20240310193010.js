...
export default function Weatherdata(props) {
    ...
    return (
        <div className="Weatherdata">
            ...
            <AtmItems img='wind 1.png' data={`${weatherData && weatherData.wind.speed} m/s`} text='Швидкість Ві' />
            <AtmItems img='pressure-white 1.png' data={`${weatherData && weatherData.main.pressure} hPa`} text='Pressure' />
            <AtmItems img='uv-white 1.png' data={weatherData && weatherData.main.value} text='UV' />
